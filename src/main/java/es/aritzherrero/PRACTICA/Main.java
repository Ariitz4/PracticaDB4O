package es.aritzherrero.PRACTICA;

import com.db4o.ObjectContainer;
import com.opencsv.CSVReader;
import com.opencsv.exceptions.CsvException;
import es.aritzherrero.BBDD.DB;
import es.aritzherrero.DAO.*;
import es.aritzherrero.MODELO.*;
...
public class Main {
	...
	private static void aniadirParticipacion(ObjectContainer db, Scanner input) {
		...
		if(eventos.size()==0) {
			...
			DaoParticipacion.insertar(new ModeloParticipacion(deportista, evento, new ModeloEquipo("QUAGMIRE KINGS ROYALE", "QKR"), 0, temporada), db);
		}
	}
